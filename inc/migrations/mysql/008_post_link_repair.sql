-- ---------------------------------------------------------------------------
-- 008 — repair legacy relative links inside article bodies (MySQL / MariaDB)
--
-- Counterpart of ../008_post_link_repair.sql. The reasoning lives there;
-- REPLACE() is spelled the same in both dialects, so only the case differs.
--
