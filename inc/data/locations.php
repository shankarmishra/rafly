...
return [
    ...
    'mumbai' => [
        ...
        'featured_services' => ['ecommerce', 'web-development', 'performance-marketing', 'web-security']
    ],
    ...
    'bangalore' => [
        ...
        'featured_services' => ['web-development', 'web-security', 'lead-automation', 'content-creation']
    ],
    ...
    'dubai' => [
        ...
        'featured_services' => ['web-development', 'ecommerce', 'web-security', 'lead-automation']
    ],
    ...
    'usa' => [
        ...
        'seo_title'       => 'Custom Web Development & Cyber Security Services USA | RAFLY',
        'meta_desc'       => 'Decoupled web application development, security hardening, Shopify e-commerce optimization, and performance marketing for US companies.',
        ...
        'quality_score'   => 80,
        'is_indexable'    => true,
        'intro'           => 'RAFLY provides remote web application development and growth engineering for US startups, SaaS platforms, and retail brands across North America.',
        'highlights'      => [
            'Bespoke PHP 8.3 & React Full-Stack Development',
        ...
        'nearby_slugs'    => ['london', 'dubai', 'greater-noida'],
        'featured_services' => ['web-development', 'web-security', 'ecommerce', 'performance-marketing']
    ]
];
